...
class _RecommendCardState extends State<RecommendCard> {
  ...
  Widget topicCard(TopicCard card) {
    Widget markWidget;
    if (card.img == null) {
      markWidget = new Text(card.content,
              ...
              new Container(
                child: new Row(
                  children: <Widget>[
                    new Expanded(
                        child: new Text(
                            card.thumbUpCount.toString() +
                                " 赞同 · " +
                                card.commentCount.toString() +
                                "评论",
                            style:
